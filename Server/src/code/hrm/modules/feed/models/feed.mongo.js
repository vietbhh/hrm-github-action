...
import savedMongoModel from "./saved.mongo.js"

export const feedSchema = baseSchema("m_feed", {
    _id: {
    ...
    methods: {
        async countSavedByUser(id) {
            const listPostSaved = await savedMongoModel.find({user_id: id}).select("id -_id").exec()
