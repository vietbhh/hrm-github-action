                                    ...
                                    <>
                                        <div className='div-birthday' onClick={ handleModalBirthday}>
                                            ...
                                            <div className='birthday'>
                                                <span>
                                                    {state.birthday.length> 1 ? useFormatMessage("modules.dashboard.events.birthday", { member : state.birthday[0].full_name, number: state.birthday.length - 1 }) : useFormatMessage("modules.dashboard.events.one_birthday", {member: state.birthday[0].full_name})}
                                                </span>
                                            </div>
                                        </div>
