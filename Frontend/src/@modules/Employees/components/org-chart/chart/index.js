...
const { default: defineBoxShadow } = require("../defs/defineBoxShadow");
const { default: defineAvatarClip } = require("../defs/defineAvatarClip");
...
function init(options) {
  ...
  function zoomClick() {
    ...
    if (this.id === zoomExtentId) {
      ...
      const scaleX = elemWidth / svgWidth - 0.03;
      const scaleY = elemHeight / svgHeight - 0.06;
