...
const { default: onClick } = require("./onClick");
...
function render(config) {
  ...
  nodeEnter
    ...
    .attr("x", nodeWidth / 2)
    .attr("y", namePos.y + nodePaddingY * 2.3)
    .attr("dy", "0.1em")
    .style("font-size", 10)
    .style("cursor", "pointer")
    .style("fill", titleColor)
    .text((d) => d.person.title ?? "Unknown");
  ...
  nodeEnter
    ...
    .attr("class", PERSON_TITLE_CLASS + " unedited")
    .attr("x", nodeWidth / 2)
    .attr("y", namePos.y + nodePaddingY * 3.4)
    .attr("dy", "0.1em")
    .style("font-size", 11)
    .style("font-weight", 400)
    .style("cursor", "pointer")
    .style("fill", titleColor)
    .text((d) => d.person.department ?? "Unknown");
