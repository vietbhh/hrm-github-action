...
const UserProfileSidebar = (props) => {
  ...
  useEffect(() => {
    ...
    if (index !== -1) {
      setState({ selectedGroup: groups[index] })
    } else {
    ...
    <div
      ...
      <PerfectScrollbar
        ...
        <div className="profile-div" style={{ cursor: "unset" }}>
          ...
          <ErpSwitch nolabel defaultValue={true} />
        </div>
        ...
        {user?.type === "group" && (
          <>
            <div className="profile-div member">
              <span className="title">
                {useFormatMessage("modules.chat.text.members")} (11)
              </span>
              <div className="profile-div-right">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  fill="none">
                  <path
                    d="M11.875 5.3125L7.5 9.6875L3.125 5.3125"
                    stroke="#212121"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
            ...
            <div className="profile-add-member">
              ...
              return (
                <div key={index} className="profile-member">
                  ...
                  <div className="div-center">
                    ...
                    {_.isArray(user.admin) && user.admin.indexOf(id) !== -1 ? (
                      <span className="des">
