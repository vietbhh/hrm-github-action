      ...
      <div
        ...
        <div
          className={classNames(
            windowWidth > 767.68 ? "emoji-web-hidden" : "hidden"
          )}>
          <svg
            ...
            />
            <path
              d="M15.5 15C14.3333 16 11.3 17.4 8.5 15"
              stroke="#696760"
              strokeLinecap="round"
            />
          </svg>
        ...
        <div
          className={classNames(
            windowWidth < 767.68 ? "emoji-mobile-hidden" : "hidden"
          )}>
          <svg
            width="20"
            height="20"
            ...
            <g id="vuesax/linear/emoji-icon">
              <g id="emoji-icon">
                <path
                  id="Vector"
                  d="M7.5 18.8337H12.5C16.6667 18.8337 18.3333 17.167 18.3333 13.0003V8.00033C18.3333 3.83366 16.6667 2.16699 12.5 2.16699H7.5C3.33333 2.16699 1.66667 3.83366 1.66667 8.00033V13.0003C1.66667 17.167 3.33333 18.8337 7.5 18.8337Z"
                  stroke="#696760"
                  strokeWidth="1.5"
                  strokeLinecap="round"
                  strokeLinejoin="round"
