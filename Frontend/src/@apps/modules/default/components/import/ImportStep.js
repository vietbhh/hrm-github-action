        ...
        <div className="d-flex flex-wrap w-100 import-step-area">
          <div className="d-flex align-items-center step-div ">
            ...
            <span
              ...
              1. {useFormatMessage("module.default.import.text.step_1")}
            </span>
          </div>
          <div className="d-flex align-items-center step-div">
            <i
            ...
            <span
              ...
              2. {useFormatMessage("module.default.import.text.step_2")}
            </span>
          </div>
          <div className="d-flex align-items-center step-div">
            <i
            ...
            <span
              ...
              3. {useFormatMessage("module.default.import.text.step_3")}
            </span>
          </div>
        </div>
      </CardBody>
