          ...
          <div className="mb-4">
            <div className="mb-2">
              <h5>
                ...
                {useFormatMessage(
                  "module.default.import.title.map_fields_step.default_fields_mapping"
                )}
              </h5>
            </div>
            <div>
              <p>
                {useFormatMessage(
                  "module.default.import.text.map_fields_step.mapping_fields_header"
                )}
              </p>
            </div>
          </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              <Space>
                ...
                <Button.Ripple
                  ...
                  {useFormatMessage("module.default.import.buttons.preview")}{" "}
