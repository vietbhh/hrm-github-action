...
$routes->get('module/([A-Za-z0-9\-\_]+)/export-template', 'App::export_template_get/$1');
$routes->post('module/([A-Za-z0-9\-\_]+)/get-mapping-fields', 'App::get_mapping_fields_post/$1');
$routes->post('module/([A-Za-z0-9\-\_]+)/get-import-data', 'App::get_import_data_post/$1');
...
$routes->post('chat/post-up-background', 'Chat::post_up_background_post', ['namespace' => 'App\Controllers']);
$routes->post('chat/post-up-avatar', 'Chat::post_up_avatar_post', ['namespace' => 'App\Controllers']);
