...
/*** Route for Settings ***/
$routes->post('employee-settings/create-employee-type', 'Settings::create_employee_type_post', ['namespace' => 'HRM\Modules\Employees\Controllers']);
$routes->get('employee-settings/load-employee-type', 'Settings::load_employee_type_get', ['namespace' => 'HRM\Modules\Employees\Controllers']);
$routes->post('employee-settings/update-employee-type/(:any)', 'Settings::update_employee_type_post/$1', ['namespace' => 'HRM\Modules\Employees\Controllers']);
$routes->post('employee-settings/delete-employee-type/(:any)', 'Settings::delete_employee_type_post/$1', ['namespace' => 'HRM\Modules\Employees\Controllers']);
$routes->post('employee-settings/create-contract-type', 'Settings::create_contract_type_post', ['namespace' => 'HRM\Modules\Employees\Controllers']);
$routes->get('employee-settings/load-contract-type', 'Settings::load_contract_type_get', ['namespace' => 'HRM\Modules\Employees\Controllers']);
$routes->post('employee-settings/update-contract-type/(:any)', 'Settings::update_contract_type_post/$1', ['namespace' => 'HRM\Modules\Employees\Controllers']);
$routes->post('employee-settings/delete-contract-type/(:any)', 'Settings::delete_contract_type_post/$1', ['namespace' => 'HRM\Modules\Employees\Controllers']);
